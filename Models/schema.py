...
class AgentSchema(BaseModel):
    """State carried through the SQL analyst graph."""
...
class JudgeSchema(BaseModel):
    """Structured verdict from the SQL safety judge."""
...
class DataAgentSchema(BaseModel):
    """State carried through the top level data agent graph."""
